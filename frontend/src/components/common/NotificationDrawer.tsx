...
import { X, CheckCheck, Bell, Calendar, UserCheck, Mail, ShieldAlert, Lock } from 'lucide-react';
          ...
          <div className="px-6 py-5 border-b border-slate-200/80 flex items-center justify-between bg-slate-50/50">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[11px] text-brand-700 font-semibold flex items-center gap-1 mt-0.5">
                  <Lock className="w-3 h-3 text-brand-600" />
                  Private to {user?.fullName} ({isChairman ? 'Chairman' : 'Member'})
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              {unreadCount > 0 && (
                <button
                  ...
                  className="text-xs font-semibold text-brand-700 hover:text-brand-800 hover:bg-brand-50 px-2.5 py-1.5 rounded-lg transition-colors flex items-center gap-1 cursor-pointer"
